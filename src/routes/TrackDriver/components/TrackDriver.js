    ...
    render() {
        ...
        return (
            ...
            <Container>
                <View style={{ flex: 1 }}>
                    <HeaderComponent />
                    <MapTrack region={region} selectedAddress={this.props.selectedAddress}
                    ...
                    />
                    {
                        ...
                        <DriverOnTheWayFooter driverInfo={this.props.driverInfo}
                    ...
                    {this.props.showDriverFound &&
                        <DriverFound driverInfo={this.props.driverInfo} getDriverLocation={this.props.getDriverLocation} />
                    }
                </View>
            </Container>
        )
